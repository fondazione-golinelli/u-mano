...
class MidiNote(object):
    ...
    def __init__(self, note=None, velocity=100, duration=250.0):
        self.note = note
        self.velocity = velocity
        self.duration = duration

    def to_list(self):
        return self.note, self.velocity, self.duration

    def to_off_list(self):
        return self.note, 0, 0
