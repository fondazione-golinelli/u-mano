...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.0, 1455.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 591.0, 73.0, 150.0, 20.0 ],
					"text" : "test sound low sine"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 1308.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 99.0, 1335.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 99.0, 1300.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 565.0, 73.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "manosola:/Users/mini1/projects/u-mano/max/onehand/v4/teaser_manosola.wav",
								"filename" : "teaser_manosola.wav",
								"filekind" : "audiofile",
								"loop" : 0,
								"content_state" : 								{
									"mode" : [ "basic" ],
...
,
					...
					"patching_rect" : [ 91.0, 1385.0, 150.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 565.0, 34.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.99999213218689, 552.83772736787796, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 754.0, 59.0, 154.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.99999213218689, 519.0, 154.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 754.0, 32.0, 154.0, 20.0 ],
					"text" : "clicca qui per opzioni audio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 303.0, 1300.0, 67.0, 22.0 ],
					"text" : "delay 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 303.0, 1263.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.99999213218689, 445.0, 420.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 59.0, 233.0, 47.0 ],
					"text" : "MANO SOLA"
				}
